...
export type KpiCatalogChart = { ariaLabel: string };
...
export type RehaKpiCatalogEntry = KpiCatalogEntryBase & { path: string; matchLabel: string };
...
export const kyoritsuKpiCatalog: readonly KyoritsuKpiCatalogEntry[] = [
	{
		...
		field: '病床利用率 (%)',
		isPrimary: true,
		chart: { ariaLabel: '病床利用率の14日間推移グラフ' },
	},
...
export const rehaKpiCatalog: readonly RehaKpiCatalogEntry[] = [
	...
	{ id: 'reha-inpatient', label: '在院数', path: '/reha', matchLabel: '在院数' },
	{ id: 'reha-excepted-impatient', label: '入院患者数', path: '/reha', matchLabel: '入院患者数' },
	{ id: 'reha-excepted-discharges', label: '退院予定数', path: '/reha', matchLabel: '退院予定数' },
	{ id: 'reha-average-stay', label: '平均在院日数', path: '/reha', matchLabel: '平均在院日数' },
	{
	...
	{ id: 'reha-floor-2-north-inpatient', label: '2階北在院数', path: '/reha/f2n', matchLabel: '2階北在院数' },
	{
	...
	{ id: 'reha-floor-2-south-inpatient', label: '2階南在院数', path: '/reha/f2s', matchLabel: '2階南在院数' },
	{
	...
	{ id: 'reha-floor-3-inpatient', label: '3階在院数', path: '/reha/f3', matchLabel: '3階在院数' },
	{ id: 'reha-floor-3-average-stay', label: '3階平均在院日数', path: '/reha/f3', matchLabel: '3階平均在院日数' },
	// 4階は在院数がフロア全体、平均在院日数が北病棟のみ。APIのdisplay_nameがそうなっているため合わせている（2026-08-28の実データで確認）
	{ id: 'reha-floor-4-inpatient', label: '4階在院数', path: '/reha/f4', matchLabel: '4階在院数' },
	{
	...
	{ id: 'reha-floor-5-inpatient', label: '5階在院数', path: '/reha/f5', matchLabel: '5階在院数' },
	{ id: 'reha-floor-5-average-stay', label: '5階平均在院日数', path: '/reha/f5', matchLabel: '5階平均在院日数' },
];
